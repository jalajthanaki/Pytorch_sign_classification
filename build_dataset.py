"""Split the SIGNS into train/val/test and resize images to 64x64.

The SIGNS comes into the following format:
    train_signs/
        0_IMG_5864.jpg
        ...
    test_signs/
...
parser.add_argument('--data_dir', default='data/SIGNS', help="Directory with the SIGNS")
